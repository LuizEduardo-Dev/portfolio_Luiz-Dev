...
export const Contact = () => {
  ...
  return (
    <section id="contact" ref={container} className="relative min-h-screen w-full bg-black py-32 px-6 md:px-20 flex flex-col justify-center overflow-hidden grainy-bg">
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="flex flex-col items-start">
          ...
          <h3 className="contact-reveal text-white font-anton text-5xl md:text-6xl lg:text-7xl uppercase italic leading-none mb-8 break-words">
            {t.contactTitle}
          </h3>
          <p className="contact-reveal text-zinc-400 font-inter text-base md:text-lg leading-relaxed max-w-sm mb-12">
            {t.contactDesc}
          </p>
